    ...
    stages {
        ...
        stage('Init') {
            ...
            steps {
                ...
                git url: 'https://github.com/juergenzimmermann/computer', branch: 'main', poll: true
            }
        }
        ...
        stage('Test, Codeanalyse, Security, Dok.') {
            ...
            post {
                always {
                  ...
                  publishHTML (target : [
                    reportDir: 'extras/doc/entwicklerhandcomputer/html',
                    reportFiles: 'entwicklerhandcomputer.html',
                    reportName: 'Entwicklerhandcomputer',
                    reportTitles: 'Entwicklerhandcomputer'
                  ])
        ...
        stage('Docker Image bauen') {
            steps {
              ...
              // sh 'docker build --tag juergenzimmermann/computer:1.0.0 .'
            }
        }
